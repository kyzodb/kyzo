...
// Trial (issue #34): single-node SSI serializability checker lives in
// `kyzo-trials::serializability` — outside the engine crate wall.
...
pub use session::observe::{CallbackEvent, CallbackId, CallbackOp};
...
pub mod oracle_harness {
    ...
    pub use crate::exec::fixpoint::eval::{
        ...
        EvalRuleSet, EvalStratum, FixedRuleEval, HeadAggrKind, INTERRUPT_STRIDE, InterruptTicker,
