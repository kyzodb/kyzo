 ...
 * (MPL-2.0): module docs added; contents unchanged.
 */

//! Fixed rules that are utilities rather than graph algorithms: constant
//! relations, CSV/JSON-lines file readers, and re-order/sort.
