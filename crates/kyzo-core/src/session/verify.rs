...
//! a caller-supplied root is never an input to this door.
...
use crate::session::normalize::SessionNormalizer;
...
use crate::store::merkle::{
    ChainedStateRoot, RootChain, StateRoot, as_of_root, link_at_cut, roots_equal_at_cut,
    state_root,
};
...
mod tests {
    ...
    // ════════════════════════════════════════════════════════════════════
    // Root tamper evidence (story #289 T4): independent recomputation
    // against stored RootChain — never a caller-supplied StateRoot as
    // expected authority.
    // ════════════════════════════════════════════════════════════════════

    fn merkle_budget() -> NonZeroU64 {
