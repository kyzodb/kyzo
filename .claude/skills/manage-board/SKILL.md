---
name: manage-board
description: The ONLY way to read or write the work board — every epic, story, column, task, and lifecycle operation goes through the planner MCP tools (prefixed mcp__planner__), never raw gh. Use for any board operation; the tool descriptions themselves are the reference.
---
