...
3. **One coherent target.** Every file lands in its exact end-state form. Never land anything "to
   refactor later", never manage a half-migrated middle: the moment code touches the repo it is the
   product.
