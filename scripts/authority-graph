...
LAYERS = {
    ...
    "value": ("kyzo-core/src/data/",),
    "runtime-catalog": ("kyzo-core/src/runtime/",),
    "storage": ("kyzo-core/src/storage/",),
    "engines": ("kyzo-core/src/engines/",),
    "query": ("kyzo-core/src/query/",),
    "record": ("kyzo-core/src/data/record",),
}
LAYER_SPINE = [
...
PARSE_BOUNDARY = ("kyzo-core/src/parse/",)
BYTE_PLANE = ("kyzo-core/src/data/value/", "kyzo-core/src/storage/",
              "kyzo-core/src/data/bitemporal.rs")
SENSITIVE = ("kyzo-core/src/query/", "kyzo-core/src/engines/",
             "kyzo-core/src/runtime/", "kyzo-core/src/storage/")
...
def scan_code(path, raw_lines, nodes, findings):
    ...
    for idx, raw in enumerate(raw_lines, start=1):
        ...
        if m:
            if path == "kyzo-core/src/data/value/mod.rs":
                findings.append(Finding(
...
def check_missing(nodes, findings):
    ...
    for name in sorted(EXPECTED):
        ...
        if exp.get("conditional"):
            ...
            continue
        findings.append(Finding(
            "missing-authority", "kyzo-core/src", 0, name,
...
def run_scan(root, allowlist_path, problems):
    """Scan kyzo-core/src under root; return (nodes, edges, planned, findings)."""
    findings, decls = [], []
    src = root / "kyzo-core" / "src"
...
def render_outputs(nodes, edges, planned, findings, nfiles):
    ...
    map_obj = {
        ...
        "scope": "kyzo-core/src", "files_scanned": nfiles,
    ...
    L.append(f"Generated by `scripts/authority-graph` (v{TOOL_VERSION}) over "
             f"`kyzo-core/src` ({nfiles} files). Regenerate with "
...
""",
        ...
        "kyzo-core/src/query/local_types.rs": """\
...
""",
        ...
        "kyzo-core/src/runtime/catalog.rs": """\
