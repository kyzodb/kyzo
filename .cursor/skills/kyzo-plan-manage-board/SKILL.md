...
description: The ONLY way to read or write the work board — plan MCP tools (`project-0-kyzo-board` / `mcp__plugin_kyzo-plan_board__*`), never raw gh. Use for any board operation; tool descriptions are the reference.
---
